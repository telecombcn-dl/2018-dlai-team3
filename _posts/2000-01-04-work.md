...
<a href="https://www.codecogs.com/eqnedit.php?latex=\tiny&space;$$\mathcal{L}_{cycle_{A}}&space;=&space;\sum_{i=1}^{N}|B_{rec}&space;-&space;B|&space;\times&space;\lambda$$" target="_blank"><img src="https://latex.codecogs.com/svg.latex?\tiny&space;$$\mathcal{L}_{cycle_{A}}&space;=&space;\sum_{i=1}^{N}|B_{rec}&space;-&space;B|&space;\times&space;\lambda$$" title="\tiny $$\mathcal{L}_{cycle_{A}} = \sum_{i=1}^{N}|B_{rec} - B| \times \lambda$$" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\tiny&space;$$\mathcal{L}_{G}&space;=&space;\mathcal{L}_{G_{A2B}}&space;&plus;&space;\mathcal{L}_{G_{B2A}}&space;&plus;&space;\mathcal{L}_{cycle_{A}}&space;&plus;&space;\mathcal{L}_{cycle_{B}}$$" target="_blank"><img src="https://latex.codecogs.com/svg.latex?\tiny&space;$$\mathcal{L}_{G}&space;=&space;\mathcal{L}_{G_{A2B}}&space;&plus;&space;\mathcal{L}_{G_{B2A}}&space;&plus;&space;\mathcal{L}_{cycle_{A}}&space;&plus;&space;\mathcal{L}_{cycle_{B}}$$" title="\tiny $$\mathcal{L}_{G} = \mathcal{L}_{G_{A2B}} + \mathcal{L}_{G_{B2A}} + \mathcal{L}_{cycle_{A}} + \mathcal{L}_{cycle_{B}}$$" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=\tiny&space;$$\mathcal{L}_{D_{A}}&space;=&space;0.5&space;\times&space;(\mathcal{L}_{D_{realA}}&space;&plus;&space;\mathcal{L}_{D_{fakeA}})$$" target="_blank"><img src="https://latex.codecogs.com/svg.latex?\tiny&space;$$\mathcal{L}_{D_{A}}&space;=&space;0.5&space;\times&space;(\mathcal{L}_{D_{realA}}&space;&plus;&space;\mathcal{L}_{D_{fakeA}})$$" title="\tiny $$\mathcal{L}_{D_{A}} = 0.5 \times (\mathcal{L}_{D_{realA}} + \mathcal{L}_{D_{fakeA}})$$" /></a>

$$ \mathcal{L}_{D_A}=0.5 \times (\mathcal{L}_{D_{Real}}+\mathcal{L}_{D_{realA}} + \mathcal{L}_{D_{fakeA}}) $$
...
Our tests regarding this advanced approach were the following:

1. perform landmark extration on both datasets

2. perform a fixed warping of images 

3. perform a warping on one image based on the landmark of another image

4. replicate the cariGAN, specially the cariGeoGAN part, using PCA of landmarks, then projecting back the obtained PCA output to landmarks and then perform the warping of the image obtained buy our first cycleGAN.
