...
</p> | ndf/ngf=32, 6 blocks ResNet, downsampling param in ResNet as 1 and 3 layer Discriminator  	 |
| <p class="center">    <img src="./img/training/64x64_100e/test3.png">
</p> | 	6 blocks ResNet, downsampling param in ResNet as 1, 1 layer Discriminator and minimum discriminator layer output = 2 |
