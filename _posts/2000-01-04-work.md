...
$$\mathcal{L}_{cycle_{A}} = \sum_{i=1}^{N}|B_{rec} - B| \times \lambda$$
...
$$\mathcal{L}_{G} = \mathcal{L}_{G_{A2B}} + \mathcal{L}_{G_{B2A}} + \mathcal{L}_{cycle_{A}} + \mathcal{L}_{cycle_{B}}$$
